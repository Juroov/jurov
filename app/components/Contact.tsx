...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const subject = encodeURIComponent(
      `Project Inquiry from ${form.name} (Budget: ${form.budget || "N/A"})`
    );
  ...
  return (
    ...
    >
      {/* Ghost watermark */}
      <div className="ghost-word" aria-hidden="true">CONNECT</div>
      ...
      >
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 lg:gap-32 items-start">
          ...
          <div>
            ...
            >
              Message{" "}
              <span className="headline-accent">Me.</span>
            </h2>
            ...
            >
              Whether you need a website built from scratch, a UI system
              designed in Figma, or a browser automation script — fill out the
